...
ROUTE_TARGETS = (
    ...
    (commands.TargetKind.DIALOG, commands._UNAUTHORED_DIALOG),  # Duplicate Ride...: gap
    ...
    (commands.TargetKind.DIALOG, commands._UNAUTHORED_DIALOG),  # Reopen Ride: gap
    ...
    (commands.TargetKind.DIALOG, commands._UNAUTHORED_DIALOG),  # Void Card...: gap
