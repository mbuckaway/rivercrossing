...
def gorba_config(*, min_lap_s: int = 1080) -> RideConfig:
    ...
    config whose laps are never flagged unless deliberately short, and
    the default 1080 s is the real GORBA min-lap the store scenarios
    persist.
    """
    return RideConfig(
