...
- **E6.1 Standings** — the core (rank, R-14 tie-break order, R-43 draw-required, DNF exclusion, both leaderboards) shipped in E4 (v0.4, `rivercrossing.standings`); E6 adds what E4 deliberately deferred: the human-readable hand-name renderer, the results-window live standings wiring, and the draggable tie-break reorder UI. E6.1.1 crafted tie fixtures / reorder re-runs / per-rider DNF excluded from the ranking — no DNF block (S1 · S2); E6.1.2 leaderboards already live from E4.
