...
`design/` is the complete build contract — numbered requirements (through R-85), a §1–§15b engineering spec, 27
...
| `design/docs-md/xrc-windows.md` | All 27 windows with frozen control names — **implementation truth for UI** |
